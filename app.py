...
def create_session():
    ...
    ses.post('http://103.159.250.194:94/attendance/attendanceLogin.php', data=login_payload)
...
def ttable(y, b, s):
    ...
    try:
        data=ses.post('http://103.159.250.194:94/TimeTables/viewTTByClass.php', data=djson)
...
def midMarks(roll, year, bran, sec, reqy='0'):
    ...
    try:
        d=ses.post('http://103.159.250.194:94/mid_marks/marksConsolidateReport.php', data=data1)
...
def get_data(rollno, year, bran, sec):
    ...
    try:
        ...
        #cookie={'PHPSESSID': os.environ['COOKIE']}
        a=ses.post('http://103.159.250.194:94/attendance/attendanceTillTodayReport.php', data=payload)
