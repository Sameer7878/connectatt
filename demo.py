...
def create_session():
    ...
    ses.post('http://192.168.3.222/attendance/attendanceLogin.php', data=login_payload)
...
def get_data( year, bran, sec):
    ...
    try:
        ...
        #print(payload)
        #cookie={'PHPSESSID': os.environ['COOKIE']}
        a=ses.post('http://192.168.3.222/attendance/attendanceTillTodayReport.php', data=payload)
        data1=sp(a.text, 'html.parser')
       # print(data1)
        att1=data1.findAll('td', attrs={'class': 'tdRollNo'})
        att2 = data1.findAll('td', attrs={'class': 'tdPercent'})
        att_data={}
        for i,j in zip(att1,att2):
            a=[]
            a.append(j.text)
            att_data[i.text.replace(' ','')]=json.dumps(a)
        #print(att_data)
        return att_data
        #print(att1)
        #data=att1.text.split('(')
...
a=['4 1 2', '4 1 3', '4 1 4', '4 10 1', '4 11 2', '4 11 3', '4 2 2', '4 2 3', '4 2 4', '4 3 2', '4 3 3', '4 3 4', '4 4 2', '4 4 3', '4 6 1', '6 1 2', '6 1 3', '6 1 4', '6 10 1', '6 11 1', '6 11 4', '6 2 2', '6 2 3', '6 2 4', '6 3 2', '6 3 3', '6 3 4', '6 4 2', '6 4 3', '6 6 2', '6 6 3', '8 1 2', '8 1 3', '8 1 4', '8 10 1', '8 2 2', '8 2 3', '8 2 4', '8 3 2', '8 3 3', '8 3 4', '8 4 2', '8 4 3', '8 6 2', '8 6 3']
c=0
for k in a:
    c +=1
    print('Progress: {0}/{1}'.format(c,45))
    try:
        roll_data = k.split(' ')
       # name = student_names[rollno]
        ...
        branch = int(roll_data[1])
        section = int(roll_data[2])
        dict1=get_data(adyear,branch,section)
        for i, j in dict1.items():
            if '(' in i:
                i=i.split('(') [0]
            cur.execute(f"select att_list, rollno from main where rollno='{i}'")
            chq=cur.fetchone()
            if chq:
                if chq[0]!=None:
                    ch=ast.literal_eval(chq[0])
                    ch.append(j)
                    j=json.dumps(ch)
                ...
                if i in student_names:
                    ...
                    na=""
                cur.execute(
                    f"insert into main(rollno,name,count,sec_det,att_list,updated_time) values('{i}', '{na}', 1, '{k}', '{j}', current_timestamp);")
                con.commit()
    except Exception as e:
        con.close()
        con=psycopg2.connect(
            'postgres://scylfjyygeactf:4a059e54ad264651837df64a3a7248a11225b7b75571db39590c37d7b8e4a6fa@ec2-23-20-140-229.compute-1.amazonaws.com:5432/de14p785paocd3')
        cur=con.cursor()
        err.append(k)
        print('error',k,e)
#data=cur.fetchone()
